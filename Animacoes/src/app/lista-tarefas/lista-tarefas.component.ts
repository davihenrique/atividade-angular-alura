...
import { checkButtonTrigger, filterTrigger, formButtonTrigger, highlightedStateTrigger, sahakeTrigger, shownStateTrigger } from '../animations';
@Component({
...
export class ListaTarefasComponent implements OnInit {
  ...
  filtrarTarefasPorDescricao(descricao: string){
    ...
    if(descricao){
      this.tarefasFiltradas = this.listaTarefas.filter(terefa =>
        terefa.descricao.toLowerCase().includes(this.campoBusca))
      } else {
